...
const FEATURE_TABS = [
  {
    gif: '/feature1.gif',
    video: '/feature1-preview.mp4',
    poster: '/feature1-poster.jpg',
  ...
  {
    gif: '/feature2.gif',
    video: '/feature2-preview.mp4',
    poster: '/feature2-poster.jpg',
  ...
  {
    gif: '/feature3.gif',
    video: '/feature3-preview.mp4',
    poster: '/feature3-poster.jpg',
...
export default function LandingPage() {
  ...
  useEffect(() => {
    ['/hero-lingowatch-fast.jpg', '/feature1-poster.jpg', '/feature2-poster.jpg', '/feature3-poster.jpg', '/me-testimonial-fast.jpg'].forEach(src => {
      const img = new Image();
      img.src = src;
    });
  }, []);
  ...
  return (
    <div style={{ backgroundColor: '#1B202A', color: '#fff', fontFamily: "'Inter', sans-serif", overflowX: 'hidden', scrollbarWidth: 'thin' }}>
      ...
      <section style={{
        ...
        backgroundImage: "url('/hero-lingowatch-fast.jpg')",
      ...
      <section id="languages" className="lw-fade-in lw-scroll-target" style={{ position: 'relative', backgroundColor: 'transparent', width: '100%', padding: '100px 0', display: 'flex', justifyContent: 'center' }}>
        <div className="lw-testimonial-card" style={{ display: 'flex', flexDirection: 'row', gap: '15px', width: 'fit-content', margin: '0 auto' }}>
          <img src="/me-testimonial-fast.jpg" alt="Musab Mohamed Ali, CEO of LingoWatch" className="lw-testimonial-img" loading="eager" decoding="async" style={{ width: '343px', height: '482px', flexShrink: 0, objectFit: 'cover', objectPosition: 'center top' }} />

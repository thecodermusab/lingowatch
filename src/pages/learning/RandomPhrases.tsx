...
import { generateAIExplanation, generateRandomPhraseEntries } from "@/lib/ai/index";
...
import { loadImportedPhraseBank, phraseBank, PhraseBankEntry } from "@/lib/data/phraseBank";
